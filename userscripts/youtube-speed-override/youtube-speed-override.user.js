...
(function () {
  ...
  function showSpeedChangeNotification() {
    ...
    const videoSpeedNotificationContainer = document.querySelector(
      '#movie_player > div:nth-child(9)'
    );
    const videoSpeedNotificationText = document.querySelector(
      '#movie_player > div:nth-child(9) > div.ytp-bezel-text-wrapper > div'
    );
    const videoSpeedIconContainer = document.querySelector(
      '#movie_player > div:nth-child(9) > div.ytp-bezel'
    );
